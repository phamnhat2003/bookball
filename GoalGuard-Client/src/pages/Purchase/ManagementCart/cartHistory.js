...
const CartHistory = () => {
    ...
    console.log("Hủy sân với order:", order); // Thêm log
    Modal.confirm({
        ...
        cancelText: 'Hủy',
        onOk() {
            handleUpdateOrder(order._id || order.id);
        },
    });
};
...
const handleUpdateOrder = async (id) => {
    ...
    try {
        ...
        const response = await bookingApi.updateOrder(categoryList, id);
        ...
        console.error("Lỗi cập nhật đặt sân:", error);
        notification["error"]({
            message: `Lỗi`,
