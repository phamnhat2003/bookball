        ...
        <Footer style={{ backgroundColor: "#1e0a3c", padding: 30, paddingTop: 80 }}>
            <Row className="footer-desktop">
                ...
                <Col span={4} className="footer">
                    ...
                    <p style={{ marginTop: 20, color: "#FFFFFF", fontWeight: 400, fontSize: 14, cursor: "pointer" }}>Trụ sở : Khoái Châu - Hưng Yên</p>
            ...
            <div style={{ textAlign: 'center' }}>
                ...
                <p style={{ color: "#FFFFFF", fontSize: 13 }}>Đồ án 3</p>
                <p style={{ color: "#FFFFFF", fontSize: 13 }}>Điện thoại: 0977584921</p>
            </div>
        </Footer>
    );
}
