import { CheckCircleOutlined, CopyOutlined, HomeOutlined, PlusOutlined, StopOutlined, UserOutlined, DeleteOutlined } from '@ant-design/icons';
    ...
    render: (image) => (
        <img
            ...
            style={{
                ...
                objectFit: 'cover',   // Cắt ảnh vừa với khung
                border: '1px solid #ddd', // Viền nhẹ (tùy chọn)
            }}
        />
    ),
    width: '10%' // Thu gọn lại để vừa hơn
}
,
        {
            title: 'Tên',
    ...
    <Space>
      {record.status !== "actived" ? (
        <Popconfirm
          ...
          cancelText="No"
        >
          <Button size="small" icon={<CheckCircleOutlined />} style={{ width: 160, borderRadius: 15, height: 30 }}>
            Mở chặn tài khoản
          </Button>
        </Popconfirm>
      ) : (
        <Popconfirm
          ...
          cancelText="No"
        >
          <Button size="small" icon={<StopOutlined />} style={{ width: 160, borderRadius: 15, height: 30 }}>
            Chặn tài khoản
          </Button>
        </Popconfirm>
      )}
  ...
  try {
    ...
    handleList(); // Load lại danh sách user
  } catch (error) {
    notification.error({
      message: 'Thông báo',
                    ...
                    >
                        ...
                        >
                            <Select placeholder="Chọn phân quyền">
                                ...
                                <Option value="isSeller">Chủ sân</Option>
